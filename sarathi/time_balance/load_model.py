...
# )
CASES = [
    (9, 2362, 10, 247, 0, 289, 0, 21588.4375, 2533.75, 16867.11865234375, 16962.0),
    (7, 2417, 11, 249, 77, 361, 77, 21457.0625, 2665.125, 16867.11865234375, 16962.0),
]
...
def main() -> None:
    ...
    t_ms = [
        ...
        for (dt, dht, brc, pt, ppt, mdcl, mppt, gmpt, gmft, cam, crm) in CASES
    ]
